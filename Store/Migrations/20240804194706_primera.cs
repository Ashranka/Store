        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingAddress_Region = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketItemss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasketItemss_Baskets_BasketId",
                        column: x => x.BasketId,
                        principalTable: "Baskets",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BasketItemss_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasketItemss_BasketId",
                table: "BasketItemss",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BasketItemss_ProductId",
                table: "BasketItemss",
                column: "ProductId");
